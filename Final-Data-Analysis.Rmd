...
test=paintings_train%>%
  select(-lot,-price,-authorstyle,-author,-Height_in,-Width_in,-Diam_in,-Surface_Rect,-Surface_Rnd,-material,-materialCat,-subject,-count,-other,-winningbidder,-Interm,-authorstandard,-sale,-school_pntg,-winningbiddertype,-Shape)
...
model1 = step(lm(logprice~.,data=test),k=2,direction="backward",trace=0)
...
var.change=c("year","diff_origin","artistliving","engraved","prevcoll","paired","finished","lrgfont","relig","landsALL","lands_sc","othgenre","portrait","discauth")

paintings_test[var.change] = lapply(paintings_test[var.change], factor)

paintings_test=paintings_test[paintings_test$position<1,]
