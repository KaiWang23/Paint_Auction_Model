...
```{r}
library(gbm)
boost.logprice =gbm(logprice~Surface + dealer + endbuyer + diff_origin + type_intermed + engraved + mat_recode+school_pntg_recode+paired + lrgfont + lands_sc + othgenre + discauth + othartist+still_life+SurfaceNA+year:dealer+year:school_pntg_recode+peasant+mytho, data=train, 
