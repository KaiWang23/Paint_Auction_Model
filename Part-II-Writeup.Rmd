...
# df.bas$xlevels[["winningbiddertype"]] <- union(df.bas$xlevels[["winningbiddertype"]], levels(test$winningbiddertype))
# 
# df.bas$xlevels[["endbuyer"]] <- union(df.bas$xlevels[["endbuyer"]], levels(test$endbuyer))
# 
# 
# df.bas$xlevels[["shape_recode"]] <- union(df.bas$xlevels[["shape_recode"]], 
#                                           levels(test$shape_recode))
